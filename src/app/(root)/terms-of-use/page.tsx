...
export const metadata: Metadata = generateMetaTags({
  ...
  keywords:
    "A1 Lifts terms of use, terms and conditions A1 Lifts, website usage policy, lift company legal terms, Bangladesh engineering services terms, A1 Lifts disclaimer, user agreement A1 Lifts, lift service access rules, escalator service policy, terms of website use",
