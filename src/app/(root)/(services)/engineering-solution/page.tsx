...
export const metadata: Metadata = generateMetaTags({
  title: "Engineering Solutions of A1 lifts and Engineering",
  description:
  ...
  keywords:
    "engineering solutions Bangladesh, electrical substation service, generator installation Bangladesh, power system services, A1 Lifts engineering services, substation company in Bangladesh, diesel generator supplier, commercial electrical engineering, generator maintenance, A1 Lifts power solutions",
