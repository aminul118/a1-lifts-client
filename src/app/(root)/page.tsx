...
export const metadata: Metadata = generateMetaTags({
  ...
  description:
    "Best lift , Escalator, Genarator, Substrations and engineering solution company in Bangladesh that provides passenger lifts, hospital lifts, and capsule lifts, with technical services, Lift maintains, spare parts of lifts, substation and genarator",
  keywords:
