...
export const metadata: Metadata = generateMetaTags({
  title: "Substations | A1 Lifts and Engineering Bangladesh",
  description:
  ...
  keywords: [
    "substations Bangladesh",
    "substation installation Bangladesh",
    "electrical substation services",
    "substation maintenance",
    "A1 Lifts substation solutions",
    "industrial substation services",
    "power system solutions Bangladesh",
